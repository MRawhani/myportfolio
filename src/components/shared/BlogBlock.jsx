  ...
  return (
    <Roll>
      <div className="blogBlock">
        <div
          className={`blogBlock__line ${
            page ? "blogBlock__line--visibleAll" : ""
          }`}
        ></div>
        <div className="blogBlock__content">
          <div className="col-2 small-flex-mobile position-relative">
            ...
            <Link
              ...
              className="blogBlock__content--readMore"
            >
              {" "}
              Read More{" "}
            </Link>
        ...
        <div className="blogBlock__blogger">
          ...
          <div className="blogBlock__blogger--info">
            <p className="">
              {blog.ownerId ? blog.ownerId.username : "Mohammed Rawhani"}
            </p>
            <p className="">
              {blog.createdAt &&
